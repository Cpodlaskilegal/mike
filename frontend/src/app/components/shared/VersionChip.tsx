 ...
 * a document has progressed beyond its initial upload. Matches the chip in
 * the side panel's edit-tab header.
 */
export function VersionChip({ n }: { n: number | null | undefined }) {
    if (typeof n !== "number" || !Number.isFinite(n) || n < 2) return null;
    return (
